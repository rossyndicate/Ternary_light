...
(NAP) mass. For that we will use a range of values of chlorohpyll:biomass ratio
and show the impact of picking a sinlge ratio from a set of ranges.
...
```{r, echo = F, cache = T, fig.width = 7,fig.height = 7, fig.cap = "At low chl_ratios (10/20), there is really no change to the correlation between tss and chl_a, but at higher ratios (100/200), the relationship does breakdown some, though not completely"}
...
```{r fig kd-pred-obs, echo = F, cache = T, fig.cap = 'Modelled light extinction coefficient (Kd) versus observed, red line is 1:1 line and blue is line of best fit, r^2 hardly varies between chlorophyll a conversion approaches.'}
...
-   Based on the above approaches and logic, the chl-a to biomass multiplier
    ...
    the 234 log ratio going forward.
